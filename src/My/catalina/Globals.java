...
public final class Globals {
    ...
    public static final String CLASS_LOADER_ATTR =
        "My.catalina.classloader";

    /**
     * Request dispatcher state.
     */
    public static final String DISPATCHER_TYPE_ATTR = 
        "My.catalina.core.DISPATCHER_TYPE";

    /**
     * Request dispatcher path.
     */
    public static final String DISPATCHER_REQUEST_PATH_ATTR = 
        "My.catalina.core.DISPATCHER_REQUEST_PATH";
    ...
    public static final String SESSION_COOKIE_NAME =
        System.getProperty("My.catalina.SESSION_COOKIE_NAME",
                "JSESSIONID");
    ...
    public static final String SESSION_PARAMETER_NAME =
        System.getProperty("My.catalina.SESSION_PARAMETER_NAME",
                "jsessionid");
    ...
    public static final boolean STRICT_SERVLET_COMPLIANCE =
        Boolean.valueOf(System.getProperty("My.catalina.STRICT_SERVLET_COMPLIANCE", "false")).booleanValue();
